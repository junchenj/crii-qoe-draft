...
In this task, we will focus on control logic as the locus of improving QoE by leveraging the heterogeneity of QoE sensitivity across requests. 
We will start with why traditional scheduling and replica selection policies are insufficient.
Then we will highlight technical challenges behind the QoE-driven control logic.

\subsection{Why new policies are needed?}
